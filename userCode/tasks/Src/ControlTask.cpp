...
void CtrlHandle()
{
    ...
    else
    {
        ...
        case 1: //移动模式
            ...
            {
                HAL_Delay(500); //这一段存疑
                if (RemoteControl::rcInfo.optional[0] == optional_up && RemoteControl::rcInfo.optional[1] ==
                    optional_up)
                {
                ...
                User_motor_set_speed(20); // 滚筒电机驱动吃球，恒定速率
            }
            else
            {
                ...
                current_angle = current_angle + RemoteControl::rcInfo.left_col * 90.0;
        ...
        case 3: //吃球模式
            ...
            User_motor_set_speed(RemoteControl::rcInfo.left_rol*30);
